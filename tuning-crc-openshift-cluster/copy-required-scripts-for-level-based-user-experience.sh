...
${SCP} -r ./tuning-crc-openshift-cluster/perf-cvo-override-remove-cluster-monitoring.yaml ${SSH_HOST}:/home/core/perf-cvo-override-remove-both-olm-cluster-monitoring.yaml
...
${SCP} -r ./tuning-crc-openshift-cluster/perf-delete-resources-of-both-olm-cluster-monitoring.sh ${SSH_HOST}:/home/core/perf-delete-resources-of-both-olm-cluster-monitoring.sh
